...
module sram (
	...
	sram_ram_2port_2050_fsqn7sa ram_2port_0 (
		.data_a    (data_a),    //   input,   width = 1,    data_a.datain_a
		.q_a       (q_a),       //  output,   width = 1,       q_a.dataout_a
		.data_b    (data_b),    //   input,   width = 1,    data_b.datain_b
		.q_b       (q_b),       //  output,   width = 1,       q_b.dataout_b
		.address_a (address_a), //   input,  width = 13, address_a.address_a
		.address_b (address_b), //   input,  width = 13, address_b.address_b
