...
module intel_rtile_cxl_top_cxltyp3_ed (
	...
	intel_rtile_cxl_top_cxltyp3_ed_intel_rtile_cxl_top_1100_vb5zkky #(
		.ADME_ENABLE                 (1),
		.PF0_MSIX_CAP_EN             (0),
		...
		.ip2hdm_aximm0_awid                (ip2hdm_aximm0_awid),                //  output,   width = 12,                   .awid
		...
		.hdm2ip_aximm0_bid                 (hdm2ip_aximm0_bid),                 //   input,   width = 12,                   .bid
		...
		.ip2hdm_aximm0_arid                (ip2hdm_aximm0_arid),                //  output,   width = 12,                   .arid
		...
		.hdm2ip_aximm0_rid                 (hdm2ip_aximm0_rid),                 //   input,   width = 12,                   .rid
		...
		.ip2hdm_aximm1_awid                (ip2hdm_aximm1_awid),                //  output,   width = 12,                   .awid
		...
		.hdm2ip_aximm1_bid                 (hdm2ip_aximm1_bid),                 //   input,   width = 12,                   .bid
		...
		.ip2hdm_aximm1_arid                (ip2hdm_aximm1_arid),                //  output,   width = 12,                   .arid
		...
		.hdm2ip_aximm1_rid                 (hdm2ip_aximm1_rid),                 //   input,   width = 12,                   .rid
