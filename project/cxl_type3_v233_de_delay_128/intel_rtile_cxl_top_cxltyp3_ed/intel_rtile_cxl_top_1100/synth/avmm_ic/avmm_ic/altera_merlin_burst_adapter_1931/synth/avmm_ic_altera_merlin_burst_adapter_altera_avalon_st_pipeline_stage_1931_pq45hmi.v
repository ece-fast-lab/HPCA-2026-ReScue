// avmm_ic_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1931_pq45hmi.v

// Generated using ACDS version 23.3 104

`timescale 1 ps / 1 ps
module avmm_ic_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1931_pq45hmi #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 102,
	...
	avmm_ic_altera_avalon_st_pipeline_stage_1930_bv2ucky #(
		...
		.in_data           (in_data),           //   input,  width = 102,          .data
		...
		.out_data          (out_data),          //  output,  width = 102,          .data
