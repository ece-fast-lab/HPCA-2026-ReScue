	intel_rtile_cxl_top_cxltyp3_ed u0 (
		...
		.ip2hdm_aximm0_awid                (_connected_to_ip2hdm_aximm0_awid_),                //  output,   width = 12,                   .awid
		...
		.hdm2ip_aximm0_bid                 (_connected_to_hdm2ip_aximm0_bid_),                 //   input,   width = 12,                   .bid
		...
		.ip2hdm_aximm0_arid                (_connected_to_ip2hdm_aximm0_arid_),                //  output,   width = 12,                   .arid
		...
		.hdm2ip_aximm0_rid                 (_connected_to_hdm2ip_aximm0_rid_),                 //   input,   width = 12,                   .rid
		...
		.ip2hdm_aximm1_awid                (_connected_to_ip2hdm_aximm1_awid_),                //  output,   width = 12,                   .awid
		...
		.hdm2ip_aximm1_bid                 (_connected_to_hdm2ip_aximm1_bid_),                 //   input,   width = 12,                   .bid
		...
		.ip2hdm_aximm1_arid                (_connected_to_ip2hdm_aximm1_arid_),                //  output,   width = 12,                   .arid
		...
		.hdm2ip_aximm1_rid                 (_connected_to_hdm2ip_aximm1_rid_),                 //   input,   width = 12,                   .rid
