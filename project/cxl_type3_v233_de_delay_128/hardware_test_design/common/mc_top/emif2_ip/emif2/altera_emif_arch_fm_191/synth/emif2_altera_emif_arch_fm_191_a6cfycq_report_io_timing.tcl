...
source "$script_dir/emif2_altera_emif_arch_fm_191_a6cfycq_report_timing_core.tcl"


if [ info exists ddr_db ] {
   unset ddr_db
}
emif2_altera_emif_arch_fm_191_a6cfycq_initialize_ddr_db ddr_db var
...
foreach inst $instances {
   ...
   if {[llength $instances] <= 1} {
      set fbasename "${::GLOBAL_emif2_altera_emif_arch_fm_191_a6cfycq_corename}"
   } else {
      set fbasename "${::GLOBAL_emif2_altera_emif_arch_fm_191_a6cfycq_corename}_${inst_id}"
   }
   ...
   emif2_altera_emif_arch_fm_191_a6cfycq_perform_core_analysis $opcname $inst pins var summary

   #######################################
   # Print out the Summary Panel for this instance

   set summary [lsort -command emif2_altera_emif_arch_fm_191_a6cfycq_sort_proc $summary]

   post_message -type info "Core: ${::GLOBAL_emif2_altera_emif_arch_fm_191_a6cfycq_corename} - Instance: $inst"
   ...
   foreach summary_line $summary {
      ...
      if {$su != "--"} {
         set su [ emif2_altera_emif_arch_fm_191_a6cfycq_round_3dp $su]
      }
      if {$hold != "--"} {
         set hold [ emif2_altera_emif_arch_fm_191_a6cfycq_round_3dp $hold]
      }
